...
interface Types {
    ...
    /**
     * For getting index of the type class. If the subclass is already registered, the registered
     * mapping is used. If the subclass is not registered, then look for its parent class if is
     * registered, if the parent class is registered, the subclass is regarded as the parent class.
     *
     * @param clazz the type class.
     * @return The index of the first occurrence of the specified class in this [Types], or -1 if
     * this [Types] does not contain the class.
     */
