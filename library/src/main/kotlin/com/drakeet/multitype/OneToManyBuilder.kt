...
internal class OneToManyBuilder<T>(
    ...
    override fun to(vararg delegates: ItemViewDelegate<T, *>) = apply {
        @Suppress("UNCHECKED_CAST") this.delegates = delegates as Array<ItemViewDelegate<T, *>>
    }

    @SafeVarargs
    @CheckResult(suggest = "#withLinker(Linker)")
    override fun to(vararg binders: ItemViewBinder<T, *>) = apply {
        @Suppress("UNCHECKED_CAST") this.delegates = binders as Array<ItemViewDelegate<T, *>>
    }
